    ...
    <Layout>
      <div className='flex items-center flex-col'>
        <div className="text-5xl mb-8">About John Fukuda</div>
          ...
          Although John Fukuda wants to fit into the crowd and act like a cool guy, he also thrives on going against the grain. He is a notorious flip-flopper.  He is both Japanese and Chinese.  This chaos or constant conflict is reflected in his ceramic work.  
          <br />
          He likes to make vases mostly because… well there’s not exact t explanation why.  Each vase is made up of multiple pieces thrown on a wheel, then stacked, and then manipulated by hand, during his favorite part of the process, what he calls post production, when the clay is “leather hard.”  On accident or by osmosis, John has channeled his inner Japanese spirit: people have found his style to be something like wabi-sabi, which is beauty in the imperfection.
          <br />
